<html>
	<head>  <title>IPL DATABASE MANAGEMENT</title>
    <meta charset="UTF-8">
...
<body>
	<button class="btn btn-light " style="float:left"><a href="schedule_u.php" style="color:">Back</a></button><div style="margin-top:10px; style : center" >
<style >
	body{
		background:#2d2d2d;
		color:white;
